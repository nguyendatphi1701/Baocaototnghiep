		...
		<div class="container">
			...
			<div class="pull-right">
				<div class="beta-breadcrumb font-large">
					<a href="{{URL::to('/trang-chu')}}">Home</a> / <span>Giới thiệu</span>
				</div>
			</div>
		...
		<div id="content">
				...
				<div class="history-slider">
					...
					<div class="history-slides">
						<div> 
							<div class="row">
							<div class="col-sm-5">
								<img src="{{('public/frontend/images/history.jpg')}}" alt="">
							</div>
							<div class="col-sm-7">
			...
			<div class="row">
				<div class="col-sm-6 wow fadeInLeft">
					<div class="beta-person media">
						...
						<img class="pull-left" src="{{('public/frontend/images/person2.jpg')}}" alt="">
			...
			<div class="row">
				...
				<div class="bets-img-hover">
						<img src="{{('public/frontend/images/person2.jpg')}}" alt="">
				</div>
