                        ...
                        <div class="panel-body">
                            ...
                            <div class="position-center">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea style="resize: none" rows="8" class="form-control" name="product_desc" id="ckeditor3">{{$pro->product_desc}}</textarea>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea style="resize: none" rows="2" class="form-control" name="product_keywords" id="ckeditor4" >{{$pro->meta_keywords}}</textarea>
                                </div>
                                 <div class="form-group">
