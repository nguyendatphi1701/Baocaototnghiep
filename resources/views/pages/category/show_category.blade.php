...
<div class="inner-header">
    <div class="fb-share-button" data-href="http://localhost/ShopPN/" data-layout="button" data-size="large"><a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u={{$url_canonical}}&amp;src=sdkpreparse" class="fb-xfbml-parse-ignore">Chia sẻ</a></div>
        <div class="container">
            <div class="pull-right">
                <div class="beta-breadcrumb font-large">
                    <a href="{{URL::to('/trang-chu')}}">Home</a> / <span>Danh mục sản phẩm</span>
                </div>
            </div>
